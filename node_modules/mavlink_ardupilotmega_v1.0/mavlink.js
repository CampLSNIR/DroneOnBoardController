...
mavlink.messages.sensor_offsets.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.mag_declination, this.raw_press, this.raw_temp, this.gyro_cal_x, this.gyro_cal_y, this.gyro_cal_z, this.accel_cal_x, this.accel_cal_y, this.accel_cal_z, this.mag_ofs_x, this.mag_ofs_y, this.mag_ofs_z]));
}
...
mavlink.messages.set_mag_offsets.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.mag_ofs_x, this.mag_ofs_y, this.mag_ofs_z, this.target_system, this.target_component]));
}
...
mavlink.messages.meminfo.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.brkval, this.freemem]));
}
...
mavlink.messages.ap_adc.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.adc1, this.adc2, this.adc3, this.adc4, this.adc5, this.adc6]));
}
...
mavlink.messages.digicam_configure.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.extra_value, this.shutter_speed, this.target_system, this.target_component, this.mode, this.aperture, this.iso, this.exposure_type, this.command_id, this.engine_cut_off, this.extra_param]));
}
...
mavlink.messages.digicam_control.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.extra_value, this.target_system, this.target_component, this.session, this.zoom_pos, this.zoom_step, this.focus_lock, this.shot, this.command_id, this.extra_param]));
}
...
mavlink.messages.mount_configure.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.target_system, this.target_component, this.mount_mode, this.stab_roll, this.stab_pitch, this.stab_yaw]));
}
...
mavlink.messages.mount_control.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.input_a, this.input_b, this.input_c, this.target_system, this.target_component, this.save_position]));
}
...
mavlink.messages.mount_status.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.pointing_a, this.pointing_b, this.pointing_c, this.target_system, this.target_component]));
}
...
mavlink.messages.fence_point.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.lat, this.lng, this.target_system, this.target_component, this.idx, this.count]));
}
...
mavlink.messages.fence_fetch_point.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.target_system, this.target_component, this.idx]));
}
...
mavlink.messages.fence_status.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.breach_time, this.breach_count, this.breach_status, this.breach_type]));
}
...
mavlink.messages.ahrs.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.omegaIx, this.omegaIy, this.omegaIz, this.accel_weight, this.renorm_val, this.error_rp, this.error_yaw]));
}
...
mavlink.messages.simstate.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.roll, this.pitch, this.yaw, this.xacc, this.yacc, this.zacc, this.xgyro, this.ygyro, this.zgyro, this.lat, this.lng]));
}
...
mavlink.messages.hwstatus.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.Vcc, this.I2Cerr]));
}
...
mavlink.messages.radio.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.rxerrors, this.fixed, this.rssi, this.remrssi, this.txbuf, this.noise, this.remnoise]));
}
...
mavlink.messages.limits_status.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.last_trigger, this.last_action, this.last_recovery, this.last_clear, this.breach_count, this.limits_state, this.mods_enabled, this.mods_required, this.mods_triggered]));
}
...
mavlink.messages.wind.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.direction, this.speed, this.speed_z]));
}
...
mavlink.messages.data16.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.type, this.len, this.data]));
}
...
mavlink.messages.data32.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.type, this.len, this.data]));
}
...
mavlink.messages.data64.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.type, this.len, this.data]));
}
...
mavlink.messages.data96.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.type, this.len, this.data]));
}
...
mavlink.messages.rangefinder.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.distance, this.voltage]));
}
...
mavlink.messages.heartbeat.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.custom_mode, this.type, this.autopilot, this.base_mode, this.system_status, this.mavlink_version]));
}
...
mavlink.messages.sys_status.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.onboard_control_sensors_present, this.onboard_control_sensors_enabled, this.onboard_control_sensors_health, this.load, this.voltage_battery, this.current_battery, this.drop_rate_comm, this.errors_comm, this.errors_count1, this.errors_count2, this.errors_count3, this.errors_count4, this.battery_remaining]));
}
...
mavlink.messages.system_time.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_unix_usec, this.time_boot_ms]));
}
...
mavlink.messages.ping.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_usec, this.seq, this.target_system, this.target_component]));
}
...
mavlink.messages.change_operator_control.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.target_system, this.control_request, this.version, this.passkey]));
}
...
mavlink.messages.change_operator_control_ack.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.gcs_system_id, this.control_request, this.ack]));
}
...
mavlink.messages.auth_key.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.key]));
}
...
mavlink.messages.set_mode.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.custom_mode, this.target_system, this.base_mode]));
}
...
mavlink.messages.param_request_read.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.param_index, this.target_system, this.target_component, this.param_id]));
}
...
mavlink.messages.param_request_list.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.target_system, this.target_component]));
}
...
mavlink.messages.param_value.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.param_value, this.param_count, this.param_index, this.param_id, this.param_type]));
}
...
mavlink.messages.param_set.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.param_value, this.target_system, this.target_component, this.param_id, this.param_type]));
}
...
mavlink.messages.gps_raw_int.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_usec, this.lat, this.lon, this.alt, this.eph, this.epv, this.vel, this.cog, this.fix_type, this.satellites_visible]));
}
...
mavlink.messages.gps_status.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.satellites_visible, this.satellite_prn, this.satellite_used, this.satellite_elevation, this.satellite_azimuth, this.satellite_snr]));
}
...
mavlink.messages.scaled_imu.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.xacc, this.yacc, this.zacc, this.xgyro, this.ygyro, this.zgyro, this.xmag, this.ymag, this.zmag]));
}
...
mavlink.messages.raw_imu.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_usec, this.xacc, this.yacc, this.zacc, this.xgyro, this.ygyro, this.zgyro, this.xmag, this.ymag, this.zmag]));
}
...
mavlink.messages.raw_pressure.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_usec, this.press_abs, this.press_diff1, this.press_diff2, this.temperature]));
}
...
mavlink.messages.scaled_pressure.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.press_abs, this.press_diff, this.temperature]));
}
...
mavlink.messages.attitude.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.roll, this.pitch, this.yaw, this.rollspeed, this.pitchspeed, this.yawspeed]));
}
...
mavlink.messages.attitude_quaternion.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.q1, this.q2, this.q3, this.q4, this.rollspeed, this.pitchspeed, this.yawspeed]));
}
...
mavlink.messages.local_position_ned.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.x, this.y, this.z, this.vx, this.vy, this.vz]));
}
...
mavlink.messages.global_position_int.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.lat, this.lon, this.alt, this.relative_alt, this.vx, this.vy, this.vz, this.hdg]));
}
...
mavlink.messages.rc_channels_scaled.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.chan1_scaled, this.chan2_scaled, this.chan3_scaled, this.chan4_scaled, this.chan5_scaled, this.chan6_scaled, this.chan7_scaled, this.chan8_scaled, this.port, this.rssi]));
}
...
mavlink.messages.rc_channels_raw.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.chan1_raw, this.chan2_raw, this.chan3_raw, this.chan4_raw, this.chan5_raw, this.chan6_raw, this.chan7_raw, this.chan8_raw, this.port, this.rssi]));
}
...
mavlink.messages.servo_output_raw.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_usec, this.servo1_raw, this.servo2_raw, this.servo3_raw, this.servo4_raw, this.servo5_raw, this.servo6_raw, this.servo7_raw, this.servo8_raw, this.port]));
}
...
mavlink.messages.mission_request_partial_list.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.start_index, this.end_index, this.target_system, this.target_component]));
}
...
mavlink.messages.mission_write_partial_list.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.start_index, this.end_index, this.target_system, this.target_component]));
}
...
mavlink.messages.mission_item.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.param1, this.param2, this.param3, this.param4, this.x, this.y, this.z, this.seq, this.command, this.target_system, this.target_component, this.frame, this.current, this.autocontinue]));
}
...
mavlink.messages.mission_request.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.seq, this.target_system, this.target_component]));
}
...
mavlink.messages.mission_set_current.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.seq, this.target_system, this.target_component]));
}
...
mavlink.messages.mission_current.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.seq]));
}
...
mavlink.messages.mission_request_list.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.target_system, this.target_component]));
}
...
mavlink.messages.mission_count.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.count, this.target_system, this.target_component]));
}
...
mavlink.messages.mission_clear_all.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.target_system, this.target_component]));
}
...
mavlink.messages.mission_item_reached.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.seq]));
}
...
mavlink.messages.mission_ack.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.target_system, this.target_component, this.type]));
}
...
mavlink.messages.set_gps_global_origin.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.latitude, this.longitude, this.altitude, this.target_system]));
}
...
mavlink.messages.gps_global_origin.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.latitude, this.longitude, this.altitude]));
}
...
mavlink.messages.set_local_position_setpoint.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.x, this.y, this.z, this.yaw, this.target_system, this.target_component, this.coordinate_frame]));
}
...
mavlink.messages.local_position_setpoint.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.x, this.y, this.z, this.yaw, this.coordinate_frame]));
}
...
mavlink.messages.global_position_setpoint_int.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.latitude, this.longitude, this.altitude, this.yaw, this.coordinate_frame]));
}
...
mavlink.messages.set_global_position_setpoint_int.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.latitude, this.longitude, this.altitude, this.yaw, this.coordinate_frame]));
}
...
mavlink.messages.safety_set_allowed_area.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.p1x, this.p1y, this.p1z, this.p2x, this.p2y, this.p2z, this.target_system, this.target_component, this.frame]));
}
...
mavlink.messages.safety_allowed_area.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.p1x, this.p1y, this.p1z, this.p2x, this.p2y, this.p2z, this.frame]));
}
...
mavlink.messages.set_roll_pitch_yaw_thrust.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.roll, this.pitch, this.yaw, this.thrust, this.target_system, this.target_component]));
}
...
mavlink.messages.set_roll_pitch_yaw_speed_thrust.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.roll_speed, this.pitch_speed, this.yaw_speed, this.thrust, this.target_system, this.target_component]));
}
...
mavlink.messages.roll_pitch_yaw_thrust_setpoint.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.roll, this.pitch, this.yaw, this.thrust]));
}
...
mavlink.messages.roll_pitch_yaw_speed_thrust_setpoint.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.roll_speed, this.pitch_speed, this.yaw_speed, this.thrust]));
}
...
mavlink.messages.set_quad_motors_setpoint.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.motor_front_nw, this.motor_right_ne, this.motor_back_se, this.motor_left_sw, this.target_system]));
}
...
mavlink.messages.set_quad_swarm_roll_pitch_yaw_thrust.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.roll, this.pitch, this.yaw, this.thrust, this.group, this.mode]));
}
...
mavlink.messages.nav_controller_output.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.nav_roll, this.nav_pitch, this.alt_error, this.aspd_error, this.xtrack_error, this.nav_bearing, this.target_bearing, this.wp_dist]));
}
...
mavlink.messages.set_quad_swarm_led_roll_pitch_yaw_thrust.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.roll, this.pitch, this.yaw, this.thrust, this.group, this.mode, this.led_red, this.led_blue, this.led_green]));
}
...
mavlink.messages.state_correction.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.xErr, this.yErr, this.zErr, this.rollErr, this.pitchErr, this.yawErr, this.vxErr, this.vyErr, this.vzErr]));
}
...
mavlink.messages.request_data_stream.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.req_message_rate, this.target_system, this.target_component, this.req_stream_id, this.start_stop]));
}
...
mavlink.messages.data_stream.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.message_rate, this.stream_id, this.on_off]));
}
...
mavlink.messages.manual_control.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.x, this.y, this.z, this.r, this.buttons, this.target]));
}
...
mavlink.messages.rc_channels_override.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.chan1_raw, this.chan2_raw, this.chan3_raw, this.chan4_raw, this.chan5_raw, this.chan6_raw, this.chan7_raw, this.chan8_raw, this.target_system, this.target_component]));
}
...
mavlink.messages.vfr_hud.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.airspeed, this.groundspeed, this.alt, this.climb, this.heading, this.throttle]));
}
...
mavlink.messages.command_long.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.param1, this.param2, this.param3, this.param4, this.param5, this.param6, this.param7, this.command, this.target_system, this.target_component, this.confirmation]));
}
...
mavlink.messages.command_ack.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.command, this.result]));
}
...
mavlink.messages.roll_pitch_yaw_rates_thrust_setpoint.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.roll_rate, this.pitch_rate, this.yaw_rate, this.thrust]));
}
...
mavlink.messages.manual_setpoint.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.roll, this.pitch, this.yaw, this.thrust, this.mode_switch, this.manual_override_switch]));
}
...
mavlink.messages.local_position_ned_system_global_offset.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.x, this.y, this.z, this.roll, this.pitch, this.yaw]));
}
...
mavlink.messages.hil_state.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_usec, this.roll, this.pitch, this.yaw, this.rollspeed, this.pitchspeed, this.yawspeed, this.lat, this.lon, this.alt, this.vx, this.vy, this.vz, this.xacc, this.yacc, this.zacc]));
}
...
mavlink.messages.hil_controls.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_usec, this.roll_ailerons, this.pitch_elevator, this.yaw_rudder, this.throttle, this.aux1, this.aux2, this.aux3, this.aux4, this.mode, this.nav_mode]));
}
...
mavlink.messages.hil_rc_inputs_raw.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_usec, this.chan1_raw, this.chan2_raw, this.chan3_raw, this.chan4_raw, this.chan5_raw, this.chan6_raw, this.chan7_raw, this.chan8_raw, this.chan9_raw, this.chan10_raw, this.chan11_raw, this.chan12_raw, this.rssi]));
}
...
mavlink.messages.optical_flow.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_usec, this.flow_comp_m_x, this.flow_comp_m_y, this.ground_distance, this.flow_x, this.flow_y, this.sensor_id, this.quality]));
}
...
mavlink.messages.global_vision_position_estimate.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.usec, this.x, this.y, this.z, this.roll, this.pitch, this.yaw]));
}
...
mavlink.messages.vision_position_estimate.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.usec, this.x, this.y, this.z, this.roll, this.pitch, this.yaw]));
}
...
mavlink.messages.vision_speed_estimate.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.usec, this.x, this.y, this.z]));
}
...
mavlink.messages.vicon_position_estimate.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.usec, this.x, this.y, this.z, this.roll, this.pitch, this.yaw]));
}
...
mavlink.messages.highres_imu.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_usec, this.xacc, this.yacc, this.zacc, this.xgyro, this.ygyro, this.zgyro, this.xmag, this.ymag, this.zmag, this.abs_pressure, this.diff_pressure, this.pressure_alt, this.temperature, this.fields_updated]));
}
...
mavlink.messages.omnidirectional_flow.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_usec, this.front_distance_m, this.left, this.right, this.sensor_id, this.quality]));
}
...
mavlink.messages.hil_sensor.prototype.pack = function(src, srcSystem, srcComponent) {
...
mavlink.messages.sim_state.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.roll, this.pitch, this.yaw, this.xacc, this.yacc, this.zacc, this.xgyro, this.ygyro, this.zgyro, this.lat, this.lng]));
}
...
mavlink.messages.radio_status.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.rxerrors, this.fixed, this.rssi, this.remrssi, this.txbuf, this.noise, this.remnoise]));
}
...
mavlink.messages.file_transfer_start.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.transfer_uid, this.file_size, this.dest_path, this.direction, this.flags]));
}
...
mavlink.messages.file_transfer_dir_list.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.transfer_uid, this.dir_path, this.flags]));
}
...
mavlink.messages.file_transfer_res.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.transfer_uid, this.result]));
}
...
mavlink.messages.battery_status.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.voltage_cell_1, this.voltage_cell_2, this.voltage_cell_3, this.voltage_cell_4, this.voltage_cell_5, this.voltage_cell_6, this.current_battery, this.accu_id, this.battery_remaining]));
}
...
mavlink.messages.setpoint_8dof.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.val1, this.val2, this.val3, this.val4, this.val5, this.val6, this.val7, this.val8, this.target_system]));
}
...
mavlink.messages.setpoint_6dof.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.trans_x, this.trans_y, this.trans_z, this.rot_x, this.rot_y, this.rot_z, this.target_system]));
}
...
mavlink.messages.memory_vect.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.address, this.ver, this.type, this.value]));
}
...
mavlink.messages.debug_vect.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_usec, this.x, this.y, this.z, this.name]));
}
...
mavlink.messages.named_value_float.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.value, this.name]));
}
...
mavlink.messages.named_value_int.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.value, this.name]));
}
...
mavlink.messages.statustext.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.severity, this.text]));
}
...
mavlink.messages.debug.prototype.pack = function(src, srcSystem, srcComponent) {
    return mavlink.message.prototype.pack.call(this, src, srcSystem, srcComponent, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.value, this.ind]));
}
...
mavlink.prototype.decode = function(msgbuf) {
    ...
    _.each(t, function(e, i, l) {
        if( 'string' === typeof t[decoder.order_map[i]]) {
            ...
            args[i] = t[decoder.order_map[i]].replace(/ +/g, '');
        } else {
